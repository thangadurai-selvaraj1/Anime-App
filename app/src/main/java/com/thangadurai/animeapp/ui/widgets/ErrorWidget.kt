...
import com.thangadurai.animeapp.extenstions.parseError
import com.thangadurai.animeapp.utils.Dp
import java.net.SocketException

@Composable
fun ErrorWidget(loadState: LoadState.Error) {
    ...
    Column(
        ...
        Text(text = loadState.toString().parseError(), color = Color.LightGray)
    }
